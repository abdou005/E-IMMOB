			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
                                            <h2 class="title text-center"><c:out value="${applicationScope.deleg}"/></h2>
                                            <c:forEach var="annonce" items="${applicationScope.listbiengov}">
                                                <div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
                                                                                    <c:choose>
                                                                                    <c:when test="${empty annonce.value}">
                                                                                        <img src="image/photoDefaut.jpg" alt="" width="200" height="200">
                                                                                    </c:when> 
                                                                                    <c:otherwise>  
                                                                                        <c:forEach var="i" items="${annonce.value}" begin="0" end="0">
                                                                                            <img src="MesImage/${i.url}" alt="" width="200" height="200">
                                                                                        </c:forEach>
                                                                                    </c:otherwise>  
                                                                                    </c:choose>
											<h2>${annonce.key.prix}</h2>
											<p>${annonce.key.type.typeAnnonce}</p>  
                                                                                        <p>${annonce.key.class.name}</p> 
											<a href="#" class="btn btn-default add-to-cart"><i class="glyphicon glyphicon-list"></i>Consulter</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">							
												<p>${annonce.key.gov}<strong> - </strong>${annonce.key.deleg.region} </p>
												<a href="annonce?ann=${annonce.key.id}" class="btn btn-default add-to-cart"><i class="glyphicon glyphicon-list"></i>Consulter</a>
											</div>
										</div>
								</div>
								<div class="choose">
