<%-- 
    Document   : inscriptionadmin
    Created on : 29-Apr-2015, 9:49:01 PM
    Author     : abdo
--%>
 ...
 <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <div class="col-sm-8">
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <strong>Utilisateur! </strong><%=conf %>.
                                    </div>
                                     <% }%>
    </div>
    <div class="col-sm-2"></div>       
...
<div class="container">   
        <h2 class="title text-center">Ajouter Un Administrateur</h2>  
<form id="defaultForm" method="post" class="form-horizontal" action="inscritAdmin">              
                        <div class="form-group">
        ...
        <div class="row">
            <% request.getSession().setAttribute("mail","bouhlaliabdallah@gmail.com"); %> 
                <section id="cart_items">
                <div class="table-responsive cart_info">
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							<td class="image">Admin</td>
							<td class="price">Email</td>
							<td class="quantity">Ville</td>
							<td class="total">Tel</td>
							<td class="total">Action</td>
                                                       
						</tr>
					</thead>
                                        <tbody>
                                            <c:forEach var="u" items="${applicationScope.listadmin}">
                                                    <tr>
							...
							<td class="cart_delete">
                                                            <c:choose>
                                                                <c:when test="${u.active==true}">     
                                                                    <a class="cart_quantity_delete" href="desactiverAdmin?ad=${u.id}" title="Desactiver Admin"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a class="cart_quantity_delete" href="activerAdmin?ad=${u.id}" title="Activer Admin"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></a>
                                                                </c:otherwise>
                                                            </c:choose>                                                         
							</td>
                                                    </tr>   
