 ...
 * @author abdo
 */
@WebFilter(filterName = "AppFilter", urlPatterns = {("/annonceProfil"),("/commentAbonneprofil"),("/modifierAnnonce"),("/sauvgardeBien")}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
