 ...
 * @author abdo
 */
@WebServlet(name = "DesactiverAnnonceAdmin", urlPatterns = {"/desactiverAnnonceAdmin"})
public class DesactiverAnnonceAdmin extends HttpServlet {
    @EJB
