		...
		<div class="container">                                           
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
                                            <c:set var="b" value="${requestScope.annonceimage}"/>                                          
				...
				<div class="col-sm-9 padding-right"> 
                                <form action="<c:url value="/uploadImg" />" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <fieldset>
                                        <legend>Envoi de fichier</legend>
                                        <% 
                                        String id = request.getAttribute("an").toString();
                                        session.setAttribute("idan", id);
                                        //request.setAttribute("idan", id);
                                        //out.println();
                                        %>
                                        <!--<div class="form-group">
                                             <label class="col-sm-3 control-label">Description </label>
                                             <div class="col-sm-6">
                                                 <textarea class="form-control" rows="3" name="desc"  value="" placeholder="(Descriptions)"></textarea>
                                             </div>
                                        </div>-->
                                        <div class="form-group">
                                             <label class="col-sm-3 control-label">Emplacement du fichier <span class="requis">*</span></label>
                                             <div class="col-sm-6">
                                                 <input accept="image/jpeg, image/gif, image/png" type="file" id="fichier" multiple="multiple" name="fichier" />
                                             </div>
                                        </div>
                                        <div class="form-group">
						...
						<ul class="media-list">
							<li class="media">
								...
								<a class="pull-left" href="#">
									<img class="media-object" src="images/blog/man-two" alt="">
								</a>
								<div class="media-body">
                                 ...
                                 <%if(request.getSession().getAttribute("usersession")!=null){%>
                                  <div class="replay-box">
                                    <form method="post" action="commentAbonneprofil">
                                                        <div class="row">
                                                                <div class="col-sm-4">
